Public Class WebForm1
                ...
                If (Request.QueryString("Action").ToString().ToUpper() = "EDIT") AndAlso (CallID.Text.Length = 0) Then
                    ...
                    Using DaConnection
                        ...
                        If DaReader.HasRows Then
                            ...
                            CalledFor.Text = ConvertDBNULLToString(DaReader("CalledOnBehalfOf")).Trim
                            ...
                            '' Added 3 Nov 2018
                            ReasonRelationshipFamilyIssues.Checked = ConvertDBNULL(DaReader("ReasonRelationshipFamilyIssues"))
                            ReasonRelationshipRomanticIssues.Checked = ConvertDBNULL(DaReader("ReasonRelationshipRomanticIssues"))
                            ...
                            '' Added 3 Nov 2018
                            ReferCompanyEAP.Checked = ConvertDBNULL(DaReader("ReferCompanyEAP"))
                            ...
                            '' Added 3 Nov 2018
                            ReferUniversitySupportServices.Checked = ConvertDBNULL(DaReader("ReferUniversitySupportServices"))

                            '' Added 3 Nov 2018
                            RatingBeginning.SelectedValue = (DaReader("DistressRatingBegining").ToString())
                            RatingEnd.SelectedValue = (DaReader("DistressRatingEnd").ToString())
                            ...
                            'Counsellor.Items.Clear()
                            'Counsellor.SelectedValue = vbNull
                            'Counsellor.DataBind()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        If CallerID.Text = "" Then
            ...
            Using DaConnection
                ...
                DaCommand.Parameters.AddWithValue("@DLLocation", DBNull.Value)      '' For Dedicated Lines 
                DaCommand.Parameters.AddWithValue("@DLType", DBNull.Value) '' For Dedicated Lines
                DaCommand.Parameters.AddWithValue("@DLSource", DBNull.Value) '' For Dedicated Lines
                DaCommand.Parameters.AddWithValue("@DLStudentNumber", DBNull.Value) '' For Dedicated Lines
                ...
                DaCommand.Parameters.AddWithValue("@CalledOnBehalfOf", CalledFor.Text)
                DaCommand.Parameters.AddWithValue("@ActionPoints", ActionPoints.Text.ToString.Replace("'", "`"))
                DaCommand.Parameters.AddWithValue("@ReasonRelationshipRomanticIssues", Convert.ToBoolean(ReasonRelationshipRomanticIssues.Checked.ToString()))
                DaCommand.Parameters.AddWithValue("@ReasonRelationshipFamilyIssues", Convert.ToBoolean(ReasonRelationshipFamilyIssues.Checked.ToString()))
                DaCommand.Parameters.AddWithValue("@ReferCompanyEAP", Convert.ToBoolean(ReferCompanyEAP.Checked.ToString()))
                DaCommand.Parameters.AddWithValue("@ReferUniversitySupportServices", Convert.ToBoolean(ReferUniversitySupportServices.Checked.ToString()))
                DaCommand.Parameters.AddWithValue("@DistressRatingBegining", RatingBeginning.Text)
                DaCommand.Parameters.AddWithValue("@DistressRatingEnd", RatingEnd.Text)
                ...
                '' DaCommand.CommandText = "Insert into CALLERS (CALLERID,Name,Surname,Age,sex,Race,Occupation,MedicalAid,Medication,Address,City,Province,PostalCode,telephone1,Telephone2,EmailAddress,Suburb) values (" & NextCallerID & ",'" & Firstname.Text & "', '" & Surname.Text & "', '" & AgeGroup.Text & "', '" & Gender.Text & "', '" & Race.Text & "','" & Occupation.Text & "', '" & MedicalAid.Text & "', '" & Medication.Text & "', '" & Address.Text & "', '" & City.Text & "', '" & ddlProvince.Text & "', '" & PostalCode.Text & "', '" & Telephone1.Text & "', '" & Telephone2.Text & "', '" & EMailAddress.Text & "','" & Suburb.Text & "')"
                DaCommand.CommandText = "Insert into CALLERS (Name,Surname,Age,sex,Race,Occupation,MedicalAid,Medication,Address,City,Province,PostalCode,telephone1,Telephone2,EmailAddress,Suburb) values ('" & Firstname.Text & "', '" & Surname.Text & "', '" & AgeGroup.Text & "', '" & Gender.Text & "', '" & Race.Text & "','" & Occupation.Text & "', '" & MedicalAid.Text & "', '" & Medication.Text & "', '" & Address.Text & "', '" & City.Text & "', '" & ddlProvince.Text & "', '" & PostalCode.Text & "', '" & Telephone1.Text & "', '" & Telephone2.Text & "', '" & EMailAddress.Text & "','" & Suburb.Text & "')"
            ...
            Using DaConnection
                ...
                If Retval = 1 Then
                    ...
                    DaCommand.CommandText = "UPDATE [CALLS] SET " &
                                            ...
                                            " [ReasonRelationshipRomanticIssues] = '" & ReasonRelationshipRomanticIssues.Checked & "', " &
                                            " [ReasonRelationshipFamilyIssues] = '" & ReasonRelationshipFamilyIssues.Checked & "', " &
                                            ...
                                            " [ReferCompanyEAP] = '" & ReferCompanyEAP.Checked & "', " &
                                            " [ReferUniversitySupportServices] = '" & ReferUniversitySupportServices.Checked & "', " &
                                            " [DistressRatingBegining] = " & RatingBeginning.SelectedItem.Value & ", " &
                                            " [DistressRatingEnd] = " & RatingEnd.SelectedItem.Value & ", " &
                                            " [Calldate] = '" & CallCalendar1.SelectedDate.ToString().Substring(0, 10) & "', " &
                                            " [CallSummary] = '" & [CallSummary].Text.ToString.Replace("'", "`") & "', " &
                                            " [HelpLine] = '" & [HelpLine].Text.ToString & "', " &
                                            " [DLCallTimeOfDay] = '" & [DLTime].Text.ToString() & "', " &
                                            " [CalledOnBehalfOf] = '" & [CalledFor].Text.ToString & "', " &
    ...
    Protected Sub Counsellor_DataBinding(sender As Object, e As EventArgs) Handles Counsellor.DataBinding

    End Sub

    Protected Sub Counsellor_DataBound(sender As Object, e As EventArgs) Handles Counsellor.DataBound
